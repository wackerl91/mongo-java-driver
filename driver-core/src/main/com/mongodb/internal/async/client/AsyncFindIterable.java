...
public interface AsyncFindIterable<T> extends AsyncMongoIterable<T> {
     ...
     */
    AsyncFindIterable<T> filter(@Nullable Bson filter);
     ...
     */
    AsyncFindIterable<T> limit(int limit);
    /**
     ...
     */
    AsyncFindIterable<T> skip(int skip);
     ...
     */
    AsyncFindIterable<T> maxTime(long maxTime, TimeUnit timeUnit);
     ...
     * @since 3.2
     */
    AsyncFindIterable<T> maxAwaitTime(long maxAwaitTime, TimeUnit timeUnit);
     ...
     */
    AsyncFindIterable<T> projection(@Nullable Bson projection);
    /**
     ...
     */
    AsyncFindIterable<T> sort(@Nullable Bson sort);
     ...
     * @return this
     */
    AsyncFindIterable<T> noCursorTimeout(boolean noCursorTimeout);
     ...
     * @return this
     */
    AsyncFindIterable<T> partial(boolean partial);
     ...
     */
    AsyncFindIterable<T> batchSize(int batchSize);
     ...
     * @since 3.5
     */
    AsyncFindIterable<T> comment(@Nullable String comment);
     ...
     * @since 3.5
     */
    AsyncFindIterable<T> max(@Nullable Bson max);
     ...
     * @since 3.5
     */
    AsyncFindIterable<T> min(@Nullable Bson min);
     ...
     * @since 3.5
     */
    AsyncFindIterable<T> returnKey(boolean returnKey);
     ...
     * @since 3.5
     */
    AsyncFindIterable<T> showRecordId(boolean showRecordId);
